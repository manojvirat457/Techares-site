...
- [X] font incrate
- [X] Background blue to dark black
- [X] Remove Numbers Cards
- [X] Latest Updates Card Desing Change
- [X] Two Card Effect Remove
- Why Techares section scroll and button
