...
export const metadata = basicMetadata({
	title:
		"Food Delivery App Development Company | Custom & White-Label Solutions – TechAres",
	description:
		"TechAres is a leading food delivery app development company offering custom and white-label solutions for restaurants, startups, and enterprises. Our apps feature live order tracking, secure payments, smart navigation, AI-powered recommendations, and multi-language support to boost customer engagement and business growth.",
	keywords:
		"food delivery app development company, custom food delivery app development, white label food delivery app solutions, restaurant delivery app development, online food ordering system development, on-demand food delivery app development, multi-restaurant food delivery app, UberEats clone app development, AI-based food delivery app solutions, food ordering and delivery software, scalable food delivery platform, startup food delivery app development",
});

export default function Page() {
	return (
		<main>
			<section className="relative  overflow-hidden px-20 pb-16 pt-40">
			...
			<ProjectSectionV4
				projectDetails={{
					...whyChooseUs,
					isButton: true,
					button: { href: "/contact", label: "Talk to Experts" },
				}}
				imagePosition="right"
				alignment="center"
