...
import {
	...
	tabs,
	workflowSteps,
} from "@/src/app/services/transport-and-logistic/-data.tsx";
...
export const metadata = basicMetadata({
	title:
		"Logistics Software Development Company | Custom Transport & Supply Chain Solutions",
	description:
		"Techares offers custom logistics software development services for transport, fleet, warehouse, and supply chain management. Boost efficiency with real-time tracking, route optimization, and AI-powered solutions tailored to your business.",
	keywords:
		"logistics software development company, transport software solutions, custom logistics software, supply chain software development, fleet management software, warehouse management software, route optimization software, logistics app development, order management system, asset tracking software, delivery management solutions",
});
...
export default function Page() {
	return (
		<>
					...
					<div className="flex flex-col-reverse items-center gap-8 md:flex-row md:items-center md:gap-4">
						<div className="w-full text-center md:w-2/3 md:text-left">
							...
							<ContactUsDialog>
								<Button
									className={cn(
										"px-4 py-2 text-sm rounded-full capitalize w-full sm:w-auto mt-3",
									)}
									size="small"
								>
			...
			<ProjectSectionV4
				projectDetails={{ ...whyChooseUs, isButton: true }}
				imagePosition="right"
				alignment="center"
