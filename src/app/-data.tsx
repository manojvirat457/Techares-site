...
import type { IndustriesSectionData, Industry } from "@/src/data/industries/v1";
import type { ServiceData } from "@/src/data/service-section/v3";
	...
	items: [
		{
			...
			title: (
				<span>
					IT consultancy & <br /> Development Services
				</span>
			),
			description:
