...
export function MobileHeader() {
  ...
  return (
    <div className="relative block [--mobile-height:84px] lg:hidden">
      {/*
       ...
       */}
      <div className="h-[--mobile-height,84px]"></div>

      <div className={headerWrapperClasses}>
        {/* Menubar  */}
        <div className="flex h-[--mobile-height,84px] items-center justify-between gap-4 border-b border-accent-900 bg-white/90 py-2 backdrop-blur-md dark:border-primary/60 dark:bg-accent-900">
