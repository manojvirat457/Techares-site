      ...
      <ul className="flex items-center gap-x-6">
            ...
            {'title' in menuItem ? (
              <>
                ...
                {menuItem.subMenuItems && menuItem.subMenuItems.length && (
                  <nav
                    ...
                    className={cn([
                      // Layout
                      'absolute left-0 top-full z-40 w-[230px] overflow-hidden bg-accent-100 shadow-lg dark:bg-accent-700',
             ...
             >
              {subMenuItem.label}
                          ...
                          <ContactUsDialog>
                            <p className={menuTriggerClasses}>
                              {subMenuItem.label}
                            </p>
                          </ContactUsDialog>
                        </li>
        ...
        >
         {menuItem.label}
                ...
                <ContactUsDialog>
                  <p className={menuTriggerClasses}>{menuItem.label}</p>
                </ContactUsDialog>
              </>
            )}
          </li>
