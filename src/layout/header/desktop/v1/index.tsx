 ...
 return (
  <header
   className={cn(
    ...
    isSticky
     ? 'sticky-header fixed left-0 top-0 w-full animate-fadeInDown bg-white/90 backdrop-blur-md [box-shadow:0px_0px_15px_10px_rgba(20, 0, 255, 0.1)] dark:bg-accent-900/90'
     : 'absolute'
   )}
  >
   <Container isFluid={true}>
    <div className="flex items-center justify-between gap-x-10">
     ...
     <section className='flex justify-center gap-4 items-center'>
      <Link href='https://web.whatsapp.com/send?phone=9363537370&text=Hi%20there!%20I%20am%20looking%20for%20your%20Services.%20Can%20you%20send%20me%20the%20Product%20Demo%20of%20https%3A%2F%2Fwww.coinsclone.com%2F' target='_blank'>
       <FaWhatsapp size={30} />
      </Link>
      <ContactUsDialog>
       <>
        <Button className={cn("rounded-full mr-5")}>
         <>
