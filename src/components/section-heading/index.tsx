  ...
  <div className={wrapperClasses}>
   ...
   <h3
    className={cn(
     ...
     size === 'xs' && 'text-base md:text-lg xm:text-xl',
     size === 'sm' && 'text-lg md:text-xl xm:text-2xl',
     size === 'md' && 'text-xl md:text-2xl xm:text-3xl',
     size === 'lg' && 'text-2xl md:text-3xl xm:text-4xl',
     size === 'xl' && 'text-3xl md:text-4xl xm:text-5xl',
     size === 'xm' && 'text-2xl md:text-3xl xm:text-4xl',
     !size && 'text-xl md:text-2xl xm:text-3xl',
     textPosition === 'start' && 'text-left',
     textPosition === 'center' && 'text-center',
     textPosition === 'end' && 'text-right'
    )}
