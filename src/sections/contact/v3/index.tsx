    ...
    <div className="grid grid-cols-1 md:grid-cols-2 [clip-path:polygon(0%_0%,100%_0%,98%_98%,2%_100%)] overflow-hidden">
     ...
     <div className="bg-black p-8">
      <DialogHeader className="mb-6">
       <div className="text-primary-light font-medium mb-2">TALK TO US</div>
       <DialogTitle className="text-xl font-bold  mb-2">Unleash the Power of Technology</DialogTitle>
