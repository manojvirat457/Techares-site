...
import { ServiceData, ServiceDetail, servicesData } from "@/data/service-section/v3";
 ...
 return (
  ...
  >
   ...
   <div className="flex flex-col">
    ...
    <span className={`${isActive ? "text-accent-100 " : "text-accent-300"
     ...
     <div className="grid lg:grid-cols-2 gap-8 ">
      ...
      <AnimatePresence mode="wait">
       ...
       >
        ...
        <p className="text-accent-800 mb-8">{currentService.mainDescription}</p>
        {/*
