      ...
      <form className="grid grid-cols-1 gap-30px md:grid-cols-2 xl:max-w-[630px]">
       ...
       <div className="flex flex-col items-start gap-4 md:col-span-2 md:flex-row md:items-center">
        ...
        <Button
         type="submit"
         className={cn(
          'min-w-[190px] after:text-accent-200 flex-none after:bg-[#003e70] bg-white hover:text-accent-200 dark:hover:text-accent-200'
         )}
        >
         <span className='text-black '>SUSCRIBE</span>
        </Button>
       </div>
      </form>
     </div>
