 ...
 return (
  ...
  >
   <div className="flex items-center justify-center">
    <div
     className={cn(
      'flex w-full items-center justify-between gap-1 rounded-md border p-2 transition-all',
...
>(({ placeholder, ...props }, ref) => {
 ...
 React.useEffect(() => {
  ...
  const timeVal = `${hour >= 12 ? hour % 12 : hour
 ...
 return (
  <Popover>
   <PopoverTrigger asChild>
    ...
    >
     <CalendarIcon className="size-4 stroke-primary" />
