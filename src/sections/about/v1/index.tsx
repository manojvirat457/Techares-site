...
export interface AboutSectionProps {
  ...
  description?: string;
  aboutUsDetails: SectionHeadingWithoutStylingProps[]
}

export function AboutSection() {
  const { images, sectionHeading, keyPoints, description, aboutUsDetails } = aboutSectionData;

  return aboutUsDetails.map((details: SectionHeadingWithoutStylingProps, index: number) => {
    console.log(index % 2)
    if (index % 2 == 1) {
      return (
