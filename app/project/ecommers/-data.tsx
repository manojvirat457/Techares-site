...
import { Clock, Users, Code2, Crown, Calendar, UserPlus, SendToBack, UsersRound, MonitorCog, Cpu, ShieldHalf, BrainCircuit, ChartNoAxesCombined, SquareStack, Settings, ShoppingBag, Store, Handshake } from 'lucide-react';
...
export const solutions = {
 ...
 description: 'At TechAres, we specialize in providing comprehensive ecommerce app development services tailored to meet your business needs.',
 solutionCard: [
  {
...
export const servicesData = {
 'Website Features': {
  ...
  mainDescription: 'Our ecommerce websites are built with powerful features to enhance user experience and drive sales.',
  cards: [
   {
    title: 'Responsive Design',
    description: 'Fully responsive layouts that adapt seamlessly to all devices and screen sizes.',
   },
   {
    title: 'Advanced Search',
    description: 'Powerful search and filtering options to help customers find products quickly.',
   },
   {
    title: 'Secure Payments',
    description: 'Integration with multiple secure payment gateways for safe transactions.',
   },
   {
    title: 'Reviews & Ratings',
    description: 'Built-in system for product reviews and ratings to build trust.',
   },
   {
    title: 'SEO Optimization',
    description: 'SEO-friendly structure to improve visibility in search results.',
   },
  ],
 },
 'User Features': {
  ...
  mainDescription: 'Provide your customers with a seamless shopping experience through our user-centric features.',
  cards: [
   {
    title: 'Easy Registration',
    description: 'Simple and quick registration process with multiple login options.',
   },
   {
 ...
 'Vendor Features': {
  ...
  mainDescription: 'Empower your vendors with robust tools to manage their products and sales effectively.',
  cards: [
   {
    title: 'Vendor Dashboard',
    description: 'Comprehensive dashboard for managing products and orders.',
   },
   {
    title: 'Commission Tracking',
    description: 'Transparent system for tracking earnings and commissions.',
   },
   {
 ...
 'Admin Features': {
  ...
  mainDescription: 'Provide administrators with essential tools to manage the platform effectively.',
  cards: [
   {
   ...
   },
   {
    ...
    description: 'Detailed analytics and reporting for platform performance.',
   },
   {
...
export const latestUpdate = {
 ...
 services: [
  ...
  },
  {
   ...
   description: 'Comprehensive analytics dashboard for tracking sales and performance.',
   icon: <ChartNoAxesCombined />,
  },
  {
   title: 'Multi-platform Integration',
   description: 'Seamless integration with various platforms and marketplaces.',
   icon: <SquareStack />,
  },
 ],
};
...
export const whyChooseSectionData: AboutSectionProps = {
 ...
 keyPoints: [
  ...
  },
  {
   ...
   description: 'We use the latest technologies to build robust and scalable apps.',
   icon: <Cpu />,
  },
  {
   title: 'Client-Centric Approach',
   description: 'We prioritize your satisfaction and work closely with you throughout the process.',
   icon: <UsersRound />,
  },
 ],
 button: {
 ...
 faqItems: [
  {
   ...
   answer: 'A: The timeline depends on the complexity of the app, but we typically deliver within 3-6 months.',
  },
  {
   question: 'Can you integrate my existing website with a mobile app?',
   answer: 'Yes, we can seamlessly integrate your existing website with a mobile app to provide a unified shopping experience.',
  },
  {
