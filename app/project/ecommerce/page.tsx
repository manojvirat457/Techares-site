       ...
       <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:gap-12">
        {solutions.solutionCard.map((solution) => (
         <div className="relative pt-16" key={solution.title}>
          <div className="absolute left-3/4 top-13 z-99 -translate-y-1/2 transform">
           {solution.icon}
          </div>
    ...
    <Container>
     <div className="relative h-auto w-full overflow-hidden md:h-[500px]">
      ...
      <div className="relative z-10 flex h-full items-center justify-end">
       {/* Image */}
       <div className="ml-8 hidden absolute -top-4 -left-24 flex-shrink-0 lg:block">
       ...
       {/* Content */}
       <div className="max-w-2xl justify-center mr-56 items-center">
        <h3
         className={'whitespace-pre-line font-secondary font-extrabold text-accent-100 dark:text-accent-700 text-lg md:text-xl text-left'} >
         {slides[currentSlide].title}
        </h3>
        <p
         className={'my-2 whitespace-pre-line font-semibold text-accent-200 dark:text-accent-700 text-left'} >
