...
import { CircleUser, Clock, CreditCard, Sparkles } from "lucide-react";
import {
 Calendar,
 Code2,
 Crown,
...
export const latestUpdate: ServiceSectionProps = {
 services: [
  ...
  {
   icon: <Icon2 />,
   title: 'Geo-Fencing for Smart Delivery Zones',
   description:
    'Optimize delivery efficiency by setting predefined service areas. This ensures that customers receive accurate delivery time estimates while helping restaurants and drivers manage orders more effectively.',
  },
  {
   icon: <Icon3 />,
   title: 'Loyalty Programs & Referral Rewards',
   description:
    'Encourage repeat orders with built-in reward systems. Customers earn points for purchases, referrals, and reviews, fostering long-term engagement and brand loyalty.',
  },
 ],
};
