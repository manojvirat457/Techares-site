 ...
 return (
  <>
   ...
   <section className="relative overflow-hidden py-16 md:py-16">
    ...
    <div className="absolute left-0 top-1/2 z-0 -translate-y-1/2 transform">
     <Image
         ...
         <div className="relative pt-16" key={feature.id}>
          <Card className="relative h-[300px] w-[400px] overflow-hidden rounded-none border-none">
           <div className="relative h-full bg-blue-50">
            ...
            <CardContent className="relative z-[1] flex h-full flex-col justify-start p-4 pt-6 pb-2">
             <SectionHeading
              title={feature.title}
   ...
   <section className="relative py-16">
    <Container>
     <div className="relative">
      {/* Image Section */}
      <div className="hidden md:absolute md:inset-0 -top-72 mb-10 md:flex flex-col items-center justify-between px-16 md:flex-row">
