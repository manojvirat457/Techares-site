...
import { faqSectionData,  projectDetails, tabContent, tabs, uniqueFeatures, whyChooseUs, workflowSteps } from './-data';
 ...
 return (
  <main>
     ...
     <div className="mb-6 flex flex-col gap-4 md:flex-row">
        ...
        {uniqueFeatures?.map((feature) => (
         <div className="relative pt-16" key={feature.id}>
          <Image
           ...
           width={50}
           height={50}
           className="absolute -left-32 top-9 z-10"
          />
          <Card className="relative h-[300px] w-[400px] overflow-hidden rounded-none border-none">
           <div className="relative h-full bg-blue-50">
            ...
            <CardContent className="relative z-[1] h-full overflow-y-auto p-6 pt-11">
             <SectionHeading
              title={feature.title}
      ...
      <div className="relative w-full max-w-md">
       <Image
        ...
        width={600}
        height={200}
        className="absolute left-9 right-1/4 top-1/2 z-0 hidden -translate-y-1/2 transform md:block"
       />
      </div>
     </div>
    </Container>
   ...
   <section className="relative py-16">
    <Container>
     <div className="relative">
      {/* Image Section */}
      <div className="absolute inset-0 -top-72 mb-10 flex flex-col items-center justify-between px-16 md:flex-row">
      ...
      {/* Content Section */}
      <div className="relative pt-[400px] md:pt-[200px]">
       <div className="absolute inset-0 bg-gradient-to-b from-primary/10 via-primary/5 to-transparent" />
       <div className="relative px-9 z-10 flex flex-col items-center lg:flex-row">
        <SectionHeading
   ...
   sectionHeading={{
    ...
    subtitle: 'WORK FLOW',
    description : 'We follow a well-structured development process at TechAres that ensures the successful delivery of a high-performing taxi app. Our approach is designed in such a way that it meets the requirements of business objectives while providing an unlimited user experience',
    alignment: 'center',
    textPosition: 'center',
   }}
    steps={workflowSteps}
