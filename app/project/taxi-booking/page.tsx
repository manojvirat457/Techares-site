...
export default function Page() {
 return (
  <>
   ...
   <section
    className={cn(
     'bg-accent-700 bg-cover bg-no-repeat bg-blend-luminosity [background-position:top_center] relative backdrop-blur-sm',
   ...
   >
    <Container>
     <div className="container h-96  relative z-10 flex justify-center items-center flex-col">
