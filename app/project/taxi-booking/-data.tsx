...
export const whyChooseUs: ProjectDetailsProps = {
 ...
 keyPoints: [
  ...
  },
  {
   ...
   description: 'TechAres provides flexible solutions that satisfy a brand’s identity and operational requirements',
  },
  {
  ...
  },
  {
   ...
   description: 'We have a dedicated support team that is available every time ready to assist during challenges.',
  },
 ],
 button : {
...
export const projectDetails: ProjectDetailsProps = {
 ...
 keyPoints: [{
  ...
  description: "A taxi booking app development company considers the standard taxi app a reliable platform for regular commuters. TechAres provides tailored taxi app solutions that meet the requirements of both individual commuters and businesses.",
  icon: <Image src='/assets/images/taxi-app/p1.png' alt='Standard Taxi App' width={40} height={40} />
 },
 {
  title: 'Corporate Taxi Solutions',
  description: "Taxi app development provides streamlined transportation catering to the needs of the business. Our Corporate Taxi solutions offer a simplified approach for businesses to manage employee transportation. It provides features ranging from centralized ride management, and automated billing to integration with payroll systems.",
  icon: <Image src='/assets/images/taxi-app/p2.png' alt='Corporate Taxi Solutions' width={40} height={40} />
 },
 {
  title: 'Startup Solutions',
  description: "TechAres’ Taxi Booking App Development supports emerging taxi service providers with scalable and cost-effective app solutions. Our Startup Taxi Solutions are designed to help new ventures launch quickly, manage operations efficiently, and grow sustainably with features like driver-partner onboarding, real-time tracking, and revenue analytics.",
  icon: <Image src='/assets/images/taxi-app/p3.png' alt='Startup Solutions' width={40} height={40} />
 }],
 image: {
