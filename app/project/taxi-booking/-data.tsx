...
export const whyChooseSectionData: AboutSectionProps = {
 ...
 keyPoints: [
  ...
  },
  {
   ...
   description: 'Our solutions are built with scalability in mind, ensuring they grow alongside your business without compromising on performance or reliability.'
  },
  {
   title: '24/7 Technical Support',
   description: 'Our dedicated support team is available around the clock, ready to assist with any challenges, ensuring smooth operations and optimal performance at all times.'
  },
 ]
};
...
export const ourWorkFlowData = {
 ...
 detailedDescription: 'At TechAres, we follow a well-structured development process to ensure the successful delivery of a high-performing taxi app. Our approach is designed to meet business objectives while providing a seamless user experience.',
 data: ourWorkFlow,
};
...
export const faqSectionData: FAQSectionProps = {
 ...
 faqItems: [
  ...
  },
  {
   ...
   answer:
    'Yes, we offer fully tailored solutions.',
  },
  {
   question: 'Do you provide post-launch support?',
   answer:
    'Absolutely, we offer ongoing maintenance and updates.',
  },
  {
  ...
  },
  {
   ...
   answer:
    'Yes, we build multi-city & multi-country solutions.'
  },
 ],
};
