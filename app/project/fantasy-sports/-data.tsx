  ...
  faqItems: [
    {
      ...
      answer:
        'We develop fantasy apps for cricket, football, basketball, baseball, and more.',
    },
    {
      question: 'How long does it take to develop a fantasy sports app?',
      answer:
        'The development time depends on the complexity, typically ranging from 8 to 16 weeks.',
    },
    {
      question: 'Can you integrate real-time data APIs into the app?',
      answer:
        'Yes, we integrate live score updates, player stats, and other real-time data sources.',
    },
    {
      question: 'Is it legal to run a fantasy sports app?',
      answer:
        'Yes, fantasy sports apps are legal in many regions. We ensure compliance with local regulations.',
    },
    {
      question: 'What monetization models can be implemented?',
      answer:
        'We offer multiple revenue models, including entry fees, ads, sponsorships, and in-app purchases.',
    },
  ],
};
...
export const methodologies: Methodology[] = [
  {
    ...
    description:
      'Understanding user needs, market trends, and competition. We analyze the fantasy sports market landscape, identify target audience preferences, and gather comprehensive requirements to ensure a competitive solution.',
    icon: <Search size={30} />,
    color: {
  ...
  },
  {
    ...
    description:
      'Creating an intuitive and engaging design for the best user experience. Our team develops wireframes, interactive prototypes, and user-friendly interfaces that make fantasy sports management seamless and enjoyable.',
  ...
  },
  {
    ...
    description:
      'Implementing core functionalities, APIs, and real-time data synchronization. We build robust backend systems, integrate live sports data feeds, and ensure smooth real-time updates for scores and statistics.',
    icon: <Code2 size={30} />,
    color: {
  ...
  },
  {
    ...
    description:
      'Ensuring bug-free performance with extensive testing. Our QA team conducts thorough testing of all features, including real-time data updates, payment processing, and user management systems.',
  ...
  },
  {
    ...
    description:
      'Publishing the app on multiple platforms and optimizing for high performance. We handle app store submissions, server deployment, and ensure optimal configuration for handling high user loads during peak sports events.',
    icon: <Rocket size={30} />,
    color: {
  ...
  },
  {
    ...
    description:
      'Continuous maintenance and feature enhancements. We provide ongoing support, regular updates, performance monitoring, and implement new features to keep your fantasy sports app competitive and engaging.',
