  ...
  solutionCard: [
    {
      ...
      icon: (
        <Image
          src="/assets/images/ecommerce/p2.png"
          alt="Customer E-commerce Website and App Development"
          width={80}
          height={80}
    ...
    },
    {
      ...
      icon: (
        <Image
          src="/assets/images/ecommerce/p4.png"
          alt="B2C E-commerce Apps"
          width={80}
          height={80}
          className="h-24 w-24 md:h-28 md:w-28"
        />
    ...
    },
    {
      ...
      icon: (
        <Image
          src="/assets/images/ecommerce/p0.png"
          alt="B2B Ecommerce Apps"
          width={80}
          height={80}
          className="h-24 w-24 md:h-28 md:w-28"
        />
    ...
    },
    {
      ...
      icon: (
        <Image
          src="/assets/images/ecommerce/p1.png"
          alt="C2C Marketplace Apps"
          width={80}
          height={80}
          className="h-24 w-24 md:h-28 md:w-28"
        />
    ...
    },
    {
      ...
      icon: (
        <Image
          src="/assets/images/ecommerce/p6.png"
          alt="Multi-Vendor Process"
          width={80}
          height={80}
          className="h-24 w-24 md:h-28 md:w-28"
        />
    ...
    },
    {
      ...
      icon: (
        <Image
          src="/assets/images/ecommerce/p5.png"
          alt="Social Commerce Apps"
          width={80}
          height={80}
          className="h-24 w-24 md:h-28 md:w-28"
        />
...
export const slides = [
  ...
  },
  {
    id: 2,
    title:
      'The Platforms We Use To Fuel Your E-Commerce App Development Success',
    description:
