...
export const BlockChainServices: ServicesProps = {
  ...
  sectionHeading: {
    title: 'Blockchain Development Services',
    description:
      'Techares is a leading blockchain development company, supported by a team of skilled developers proficient in creating robust, scalable, and secure blockchain solutions. With 250+ experts on board, we have successfully delivered 150+ blockchain projects for major brands and Fortune 500 companies globally. From strategy and design to development and deployment, we manage your entire blockchain project lifecycle. \n Whether you need a simple blockchain application or a complex, organization- wide blockchain solution, our developers have extensive experience across various domains and projects to meet your specific requirements.We are your go- to team to bring your blockchain ideas to life.',
  },
  description:
