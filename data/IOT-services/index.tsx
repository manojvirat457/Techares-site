...
export const IotHeading: SectionHeadingWithoutStylingProps = {
    title: 'Leading IoT Development Company',
    description: 'Transform your business operations and unlock new opportunities with our cutting-edge IoT development services, designed to enhance efficiency, productivity, and connectivity.'
}
export const IotServiceHeading: SectionHeadingWithoutStylingProps = {
    title: 'IoT Development Services',
    description:
        'Leverage our technical expertise and industry experience to access a wide range of IoT development services tailored to your unique business challenges. Here are some of our key services:',

}
export const IotServices: ServicesProps = {
    images: {
        image1: {
    ...
    sectionHeading: {
        title: 'IoT Development Services',
        description: 'Techares is a premier IoT development company, supported by a team of skilled developers proficient in creating robust, scalable, and secure IoT solutions. With 250+ experts on board, we have successfully delivered 150+ IoT solutions for major brands and Fortune 500 companies globally. From strategy and design to development and deployment, we manage your entire IoT project lifecycle.\nWhether you need a simple IoT application or a complex, organization-wide IoT ecosystem, our developers have extensive experience across various domains and projects to meet your specific requirements. We are your go-to team to bring your IoT ideas to life.'
    ...
    cards: [
        {
            ...
            description:
                'Create bespoke IoT solutions that enhance your business operations and deliver tangible results. Our custom development services ensure your IoT solutions align perfectly with your business needs.',
        },
        {
            icon: <Icon1 />,
            title: 'IoT Consulting',
            description:
                'Receive expert guidance on IoT strategy, technology selection, and implementation. Our consulting services help you optimize your IoT investments and achieve your business goals.',
        },
        {
            icon: <Icon1 />,
            title: 'IoT Integration',
            description:
                'Integrate IoT devices seamlessly with existing systems and third-party services. Our integration services ensure smooth data flow and operational efficiency.',
        },
        {
            icon: <Icon1 />,
            title: 'IoT Platform Development',
            description:
                'Develop robust and scalable IoT platforms that support your business needs. Our platforms enable seamless device connectivity, data management, and real-time analytics.',
        },
        {
            icon: <Icon1 />,
            title: 'IoT Application Development',
            description:
                'Build engaging IoT applications that maximize your online presence across the world. Our IoT applications enhance user experience and drive business growth.',
        },
        {
            icon: <Icon1 />,
            title: 'IoT Data Analytics',
            description:
                'Implement data analytics solutions that transform IoT data into actionable insights. Our solutions help you make informed decisions and improve operational efficiency.',
        },
        {
            icon: <Icon1 />,
            title: 'IoT Security',
            description:
                'Ensure the security of your IoT solutions with our comprehensive IoT security services. We implement robust security measures to protect your data and devices from threats.',
        },
        {
            icon: <Icon1 />,
            title: 'IoT Maintenance and Support',
            description:
                'Ensure the smooth operation of your IoT solutions with our maintenance and support services. We provide ongoing support to keep your IoT systems updated, secure, and running efficiently.',
        },
    ],
}
...
export const IotSolutions: SectionHeadingWithoutStylingProps = {

    title: 'IoT Solutions We Offer',
    description: 'Our expertise in IoT development spans a wide range of solutions tailored to fit every unique business need. Whether developing new IoT applications or enhancing existing systems, our developers ensure the highest quality and performance. Explore some of our exceptional solutions:'
        ...
        posts: [
            {
                ...
                titleone:
                    'Develop smart home solutions that enhance convenience, security, and energy efficiency. Our solutions include smart lighting, smart thermostats, and home automation systems.',
        ...
        posts: [
            {
                ...
                titleone:
                    'Implement industrial IoT solutions that improve operational efficiency and productivity. Our solutions include predictive maintenance, asset tracking, and remote monitoring systems.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
    {
        name: 'Healthcare IoT Solutions',
        posts: [
            {
                id: 1,
                heading: 'Healthcare IoT Solutions',
                titleone:
                    'Create healthcare IoT solutions that enhance patient care and streamline operations. Our solutions include remote patient monitoring, smart medical devices, and telehealth applications.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
    {
        name: 'Retail IoT Solutions',
        posts: [
            {
                id: 1,
                heading: 'Retail IoT Solutions',
                titleone:
                    'Develop retail IoT solutions that enhance customer experience and optimize operations. Our solutions include smart shelves, inventory management systems, and personalized marketing.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
    {
        name: 'Agricultural IoT Solutions',
        posts: [
            {
                id: 1,
                heading: 'Agricultural IoT Solutions',
                titleone:
                    'Implement agricultural IoT solutions that improve crop yield and resource management. Our solutions include precision farming, smart irrigation systems, and livestock monitoring.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
    {
        name: 'Automotive IoT Solutions',
        posts: [
            {
                id: 1,
                heading: 'Automotive IoT Solutions',
                titleone:
                    'Create automotive IoT solutions that enhance vehicle performance and safety. Our solutions include connected cars, fleet management systems, and telematics.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                titleone:
                    'Develop smart city solutions that enhance urban living and improve city management. Our solutions include smart lighting, waste management systems, and traffic management.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
...
export const iotTech: SectionHeadingWithoutStylingProps = {
    title: "Technology Stack Our IoT Developers Use",
    description: "Our IoT developers utilize the latest tools and technologies to deliver comprehensive and reliable solutions, ensuring your IoT systems meet the highest standards of quality."
}
export const iotSectionData: ServiceSectionPropss = {
    services: [
        {
            icon: <Icon1 />,
            title: 'Healthcare',
            description:
                'Develop IoT solutions that enhance patient care, streamline operations, and improve healthcare outcomes.',
        },
        {
            icon: <Icon1 />,
            title: 'Manufacturing',
            description:
                'Implement IoT solutions that optimize manufacturing processes, improve productivity, and reduce costs.',
        },
        {
            icon: <Icon1 />,
            title: 'Retail',
            description:
                'Create IoT solutions that enhance customer experience, streamline operations, and boost sales.',
        },
        {
            icon: <Icon1 />,
            title: 'Agriculture',
            description:
                'Develop IoT solutions that improve crop yield, resource management, and overall efficiency in farming operations.',
        },
        {
            icon: <Icon1 />,
            title: 'Automotive',
            description:
                'Implement IoT solutions that enhance vehicle performance, safety, and connectivity.',
        },
        {
            icon: <Icon1 />,
            title: 'Smart Cities',
            description:
                'Create IoT solutions that improve urban living, enhance city management, and promote sustainability.',
        },
        {
            icon: <Icon1 />,
            title: 'Energy',
            description:
                'Develop IoT solutions that optimize energy consumption, improve grid management, and enhance sustainability.',
        },
        {
            icon: <Icon1 />,
            title: 'Logistics',
            description:
                'Implement IoT solutions that improve supply chain visibility, optimize logistics, and enhance operational efficiency.',
        },
    ],
};

export const WhatMakesIot: WhatMakesProps = {
    sectionHeading2: {
        title: 'What Makes Us a Top IoT Development Company',
        description:
            'Techares has been a leading IoT development company for over 10 years, utilizing advanced technologies to deliver innovative solutions for clients globally. Our team of experts excels in leveraging technology to drive business success across various industry verticals. We provide business-driven and growth-centric IoT development services with faster turnaround times and better ROI for businesses. Here’s why you should choose us:',
    },
    aboutUsPoints: [
...
export const iotIndustry: SectionHeadingWithoutStylingProps = {
    title: "Industries We Serve",
    description: "As a top IoT development services provider, we deliver comprehensive solutions tailored to meet specific industry needs. Enhance your business capabilities with our expertise and solutions to overcome industry challenges. We serve various industry verticals, including:"
}

export const imageIot: ImageLayout = {
