...
export const aboutSectionData: AboutSectionProps = {
 ...
 sectionHeading: {
  ...
  description: "Techares is at the forefront of modern technologies including blockchain, AI, IoT, DevOps, and more. As an innovative digital agency, we propel in offering cutting-edge IT solutions to businesses of all sizes. By leveraging innovative technologies, we empower businesses to achieve their goals through intelligent, efficient, and tailored applications."
 },
 isCard: true,
 keyPoints: [
  {
...
export const whyChooseSectionDataTwo: ProjectDetailsProps = {
 ...
 keyPoints: [
  {
   title: 'Unmatched Technical Expertise – Versatile solutions tailored to your unique needs',
  },
  {
   title: 'Client-Centric Approach – We listen, adapt, and deliver with precision',
  },
  {
   title: 'Optimized & Efficient Operations – Fast, cost-effective, and result-driven processes',
  },
  {
   title: 'Complete Transparency & Traceability – Clear workflows and measurable outcomes',
  },
  {
   title: 'Proven Reliability – Consistent excellence and unwavering support'
  }
 ],
 image: {
