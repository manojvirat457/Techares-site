...
export const EcommerceHeading: SectionHeadingWithoutStylingProps = {
    title: 'Leading E-commerce Solutions Provider',
    description: 'Transform your online business with our comprehensive and innovative e-commerce solutions, designed to deliver seamless, scalable, and high-performance digital commerce experiences.'
}
export const EcommerceServiceHeading: SectionHeadingWithoutStylingProps = {
    title: 'E-commerce Solutions Services',
    description:
        'Leverage our e-commerce expertise and industry experience to access a wide range of e-commerce solutions tailored to your unique business challenges. Here are some of our key e-commerce development services:',

}
export const EcommerceServices: ServicesProps = {
    images: {
        image1: {
    ...
    sectionHeading: {
        ...
        description: 'Techares is a top-tier e-commerce solutions provider, staffed by a team of expert developers and designers skilled in creating powerful, scalable, and secure e-commerce platforms. With 250+ e-commerce specialists on board, we have successfully delivered 150+ e-commerce solutions for major brands and Fortune 500 companies worldwide. From strategy and UX/UI design to development and deployment, we handle your entire e-commerce journey.\nWhether you need a simple online store or a complex, enterprise-grade e-commerce platform, our developers have extensive experience across various domains and projects, ensuring your specific needs are met. We are your one-stop team to bring your e-commerce ideas to life.'
    ...
    cards: [
        {
            ...
            description:
                'Build custom e-commerce platforms with our development services. We develop tailored e-commerce solutions that enhance your online presence and deliver tangible business results.',
        },
        {
            icon: <Icon1 />,
            title: 'E-commerce Strategy and Consulting',
            description:
                'Develop a robust e-commerce strategy with our consulting services. We help you choose the right platforms and solutions to meet your business goals and ensure a successful e-commerce journey.',
        },
        {
            icon: <Icon1 />,
            title: 'UX/UI Design for E-commerce',
            description:
                'Create engaging and user-friendly e-commerce interfaces with our UX/UI design services. We design intuitive and visually appealing interfaces that enhance user experience and drive conversions.',
        },
        {
            icon: <Icon1 />,
            title: 'E-commerce Platform Development',
            description:
                'Develop powerful and scalable e-commerce platforms with our expert services. We build platforms that support your business growth and ensure seamless online shopping experiences.',
        },
        {
            icon: <Icon1 />,
            title: 'E-commerce Mobile App Development',
            description:
                'Expand your reach with our e-commerce mobile app development services. We develop high-performance mobile apps that provide a seamless shopping experience on the go.',
        },
        {
            icon: <Icon1 />,
            title: 'E-commerce Integration Services',
            description:
                'Integrate your e-commerce platform with existing systems and third-party services. We provide seamless integration services to ensure your e-commerce solution works harmoniously with other applications.',
        },
        {
            icon: <Icon1 />,
            title: 'Payment Gateway Integration',
            description:
                'Ensure secure and seamless transactions with our payment gateway integration services. We integrate reliable payment gateways that support multiple payment methods and currencies.',
        },
        {
            icon: <Icon1 />,
            title: 'E-commerce SEO and Digital Marketing',
            description:
                'Enhance your online visibility with our SEO and digital marketing services. We implement effective strategies to drive traffic, increase conversions, and boost your online sales.',
        },
        {
            icon: <Icon1 />,
            title: 'E-commerce Maintenance and Support',
            description:
                'Ensure the smooth operation of your e-commerce platform with our maintenance and support services. We provide ongoing support to keep your platform updated, secure, and running efficiently.',
        },
        {
            icon: <Icon1 />,
            title: 'E-commerce Analytics and Reporting',
            description:
                'Gain valuable insights with our e-commerce analytics and reporting services. We implement analytics tools that help you track performance, understand customer behavior, and make data-driven decisions.',
        },
    ],
}
...
export const ecommerceSolutions: SectionHeadingWithoutStylingProps = {

    title: 'E-commerce Solutions We Offer',
    description: 'Our e-commerce expertise spans a wide range of solutions tailored to fit every unique business need. Whether developing new e-commerce platforms from scratch or enhancing existing solutions, our developers ensure the highest quality and performance. Explore some of our exceptional solutions:'
...
export const ecommerceCategories = [
    {
        ...
        posts: [
            {
                id: 1,
                heading: 'B2B E-commerce Solutions',
                titleone:
                    'Develop robust B2B e-commerce platforms that cater to business clients. We build solutions that streamline business processes and enhance B2B transactions.',
    ...
    },
    {
        ...
        posts: [
            {
                id: 1,
                heading: 'B2C E-commerce Solutions',
                titleone:
                    'Create engaging B2C e-commerce platforms that cater to individual customers. We develop solutions that enhance user experience and drive consumer sales.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                titleone:
                    'Launch multi-vendor marketplaces with our development services. We build scalable and secure marketplaces that connect buyers and sellers seamlessly.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
    {
        name: 'Subscription-based E-commerce',
        posts: [
            {
                id: 1,
                heading: 'Subscription-based E-commerce',
                titleone:
                    'Implement subscription-based e-commerce models with our expert services. We develop platforms that support recurring billing and subscription management.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                titleone:
                    'Leverage headless commerce architecture for a flexible and scalable e-commerce solution. We develop headless commerce platforms that separate the front-end from the back-end, allowing for greater customization and performance.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
    {
        name: 'E-commerce Chatbots and AI',
        posts: [
            {
                id: 1,
                heading: 'E-commerce Chatbots and AI',
                titleone:
                    'Enhance customer engagement with our e-commerce chatbot and AI solutions. We implement intelligent chatbots that provide personalized shopping experiences and improve customer support.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                titleone:
                    'Integrate social media with your e-commerce platform to boost sales and customer engagement. We develop social commerce solutions that enable seamless shopping experiences on social media platforms.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
...
export const ecommerceTech: SectionHeadingWithoutStylingProps = {
    title: "Technology Stack Our E-commerce Developers Use",
    description: "Our e-commerce developers utilize the latest tools and technologies to deliver comprehensive and reliable e-commerce solutions, ensuring your platform meets the highest standards of quality."
}
export const ecommerceSectionData: ServiceSectionPropss = {
    services: [
        {
            icon: <Icon1 />,
            title: 'Fashion and Apparel',
            description:
                'Create stunning and user-friendly online stores for fashion and apparel brands that enhance the shopping experience and drive sales.',
        },
        {
            icon: <Icon1 />,
            title: 'Electronics and Gadgets',
            description:
                'Develop feature-rich e-commerce platforms for electronics and gadget retailers that provide detailed product information and seamless transactions.',
        },
        {
            icon: <Icon1 />,
            title: 'Health and Beauty',
            description:
                'Launch engaging e-commerce solutions for health and beauty products that provide personalized shopping experiences and boost customer loyalty.',
        },
        {
            icon: <Icon1 />,
            title: 'Food and Beverage',
            description:
                'Build efficient and scalable e-commerce platforms for food and beverage businesses that support online ordering, delivery, and subscription models.',
        },
        {
            icon: <Icon1 />,
            title: 'Home and Furniture',
            description:
                'Create visually appealing e-commerce platforms for home and furniture retailers that offer detailed product views and easy navigation.',
        },
        {
            icon: <Icon1 />,
            title: 'Automotive',
            description:
                'Develop comprehensive e-commerce solutions for automotive parts and accessories that provide a seamless shopping experience and efficient order management.',
        },
        {
            icon: <Icon1 />,
            title: 'Books and Media',
            description:
                'Launch engaging e-commerce platforms for books and media retailers that offer personalized recommendations and seamless transactions.',
        },
        {
            icon: <Icon1 />,
            title: 'Sports and Outdoors',
            description:
                'Build dynamic e-commerce platforms for sports and outdoor equipment retailers that provide detailed product information and a seamless shopping experience.',
        },
    ],
};

export const WhatMakesEcommerce: WhatMakesProps = {
    sectionHeading2: {
        title: 'What Makes Us a Top E-commerce Solutions Provider',
        description:
            'Techares has been a leading e-commerce solutions provider for over 10 years, utilizing advanced technologies to deliver innovative e-commerce solutions for clients globally. Our team of e-commerce experts excels in leveraging the power of digital commerce for businesses across various industry verticals. We provide business-driven and growth-centric e-commerce services with faster turnaround times and better ROI for businesses. Here’s why you should choose us:',
    },
    aboutUsPoints: [
...
export const ecommerceIndustry: SectionHeadingWithoutStylingProps = {
    title: "Industries We Serve",
    description: "As a top e-commerce solutions provider, we deliver comprehensive e-commerce solutions tailored to meet specific industry needs. Enhance your business capabilities with our e-commerce expertise and solutions to overcome industry challenges. We serve various industry verticals, including:"
}
export const imageEcommerce: ImageLayout = {
