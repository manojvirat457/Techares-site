...
export const webDevHeading: SectionHeadingWithoutStylingProps = {
    title: 'Leading Web Development Company',
    description: 'Elevate your business with our cutting-edge web development solutions designed to enhance user engagement, improve functionality, and drive business growth.'
}
export const webDevServiceHeading: SectionHeadingWithoutStylingProps = {
    title: 'Web Development Services',
    description:
        'Harness our technical expertise and industry experience to access comprehensive web development services tailored to your unique business challenges. Here are some of our web development solutions:',

}
export const WebDevServices: ServicesProps = {
    images: {
        image1: {
    ...
    sectionHeading: {
        ...
        description: 'Techares is a premier web development company, boasting an expert team of developers who excel in creating high-performance, scalable, and secure web applications. With 250+ developers, we\'ve delivered over 150+ advanced websites and web applications for major brands and Fortune 500 companies worldwide.From strategy and UI/ UX design to development, we manage your entire project to ensure seamless delivery and exceptional results.\nWhether you need a simple website for your business or a complex web application to manage your operations, our developers have extensive experience across various domains and projects, ensuring your specific needs are met. We are your one-stop team to bring your vision to the web.'
    ...
    cards: [
        {
            ...
            description:
                'From ideation to quality control to post-deployment, we help businesses create impactful, user-centric web applications that enhance productivity and deliver tangible business outcomes. Leverage our custom web development services to accelerate your time to market and outperform the competition.',
        },
        {
            icon: <Icon1 />,
            title: 'E-commerce Development',
            description:
                'We build robust and scalable e-commerce platforms that provide a seamless shopping experience for your customers. Our e-commerce solutions are designed to increase your online sales and customer engagement with features like easy navigation, secure payment gateways, and personalized user experiences.',
        },
        {
            icon: <Icon1 />,
            title: 'CMS Development',
            description:
                'Manage your content effortlessly with our Content Management System (CMS) development services. We create custom CMS solutions that allow you to update and manage your website content with ease, ensuring your site is always up-to-date and relevant.',
        },
        {
            icon: <Icon1 />,
            title: 'Web Portal Development',
            description:
                'Develop interactive and feature-rich web portals that cater to your business needs. From enterprise portals to customer and partner portals, we deliver solutions that enhance communication, collaboration, and information sharing.',
        },
        {
            icon: <Icon1 />,
            title: 'Progressive Web App (PWA) Development',
            description:
                'Deliver app-like experiences with our Progressive Web App development services. PWAs combine the best of web and mobile apps, offering offline access, push notifications, and fast loading times to enhance user engagement.',
        },
        {
            icon: <Icon1 />,
            title: 'API Development and Integration',
            description:
                'We offer API development and integration services to ensure seamless connectivity between your web applications and third-party systems. Enhance your web application\'s functionality by integrating it with external services and data sources.',
        },
        {
            icon: <Icon1 />,
            title: 'Maintenance and Support',
            description:
                'Ensure your web applications remain up-to-date, secure, and optimized with our comprehensive maintenance and support services. We provide regular updates, security patches, and performance enhancements to keep your website running smoothly.',
        },
    ],
}
...
export const webDevSolutions: SectionHeadingWithoutStylingProps = {

    title: 'Web Development Solutions We Offer',
    description: 'Our expertise spans a wide range of web development solutions, tailored to fit every unique business need. Whether developing web applications from scratch or enhancing existing ones, our developers provide the full potential to drive your business forward. Explore some of our exceptional solutions:'
...
export const webDevCategories = [
        ...
        posts: [
            {
                ...
                titleone:
                    'Build a powerful online store with our e-commerce web development solutions. Our feature-rich e-commerce platforms help businesses to reach more customers, increase sales, and enhance customer loyalty.',
        ...
        posts: [
            {
                ...
                titleone:
                    'Create a strong online presence with a professional corporate website. We design and develop corporate websites that effectively communicate your brand message and engage your audience.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                titleone:
                    'Develop dynamic and responsive web applications tailored to your business requirements. Our web applications are designed to provide an optimal user experience across all devices and platforms.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                heading: 'Portals',
                titleone:
                    'Enhance communication and collaboration with our web portal development services. We build customized portals for businesses, communities, and organizations to streamline processes and improve user engagement.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
    {
        ...
        posts: [
            {
                id: 1,
                heading: 'CMS Websites',
                titleone:
                    'Manage your website content effortlessly with our custom CMS development solutions. Our CMS websites provide an intuitive interface for easy content updates and management.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                heading: 'PWAs',
                titleone:
                    'Deliver superior user experiences with our Progressive Web Apps. PWAs offer the functionality of a mobile app with the accessibility of a website, ensuring a seamless experience for your users.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
...
export const webDevTech: SectionHeadingWithoutStylingProps = {
    title: "Technology Stack Our Web Developers Use",
    description: "Our web developers are skilled in providing web development services utilizing the latest technology stacks, ensuring high performance, security, and scalability for your web applications."
}
export const webDevSectionData: ServiceSectionPropss = {
    services: [
        {
            icon: <Icon1 />,
            title: 'Banking & Fintech',
            description:
                'We develop secure and scalable web applications for banking and fintech businesses, including online banking platforms, payment gateways, and financial management systems.',
        },
        {
            icon: <Icon1 />,
            title: 'Retail & E-Commerce',
            description:
                'Our next-gen e-commerce solutions empower B2B & B2C businesses to reach more customers and improve sales through feature-rich online stores and marketplaces.',
        },
        {
            icon: <Icon1 />,
            title: 'Healthcare & Fitness',
            description:
                'We provide smart web development solutions for the healthcare industry, including telemedicine platforms, patient management systems, and fitness tracking applications.',
        },
        {
            icon: <Icon1 />,
            title: 'Supply Chain & Logistics',
            description:
                'Digitalize your supply chain and logistics operations with our web solutions, enhancing efficiency and sustainability through advanced logistics management systems.',
        },
        {
            icon: <Icon1 />,
            title: 'Travel & Tourism',
            description:
                'Offer seamless travel experiences with our web solutions, including trip planning tools, booking systems, and local guide applications.',
        },
        {
            icon: <Icon1 />,
            title: 'Sports & Games',
            description:
                'Create immersive virtual experiences for fans with our specialized sports web applications, driving engagement and revenue for your business.',
        },
        {
            icon: <Icon1 />,
            title: 'Media & Entertainment',
            description:
                'Launch OTT platforms, media apps, and entertainment portals with our web development services, catering to your audience\'s needs with cutting-edge solutions.',
        },
        {
            icon: <Icon1 />,
            title: 'Education & E-Learning',
            description:
                'Enter the online learning market with our innovative education web applications, designed for teachers, professionals, and learners.',
        },
    ],
};

export const WhatMakesWebDev: WhatMakesProps = {
    sectionHeading2: {
        title: 'What Makes Us a Top Web Development Company',
        description:
            'Techares has been a top web development company for over 10 years, utilizing groundbreaking technologies to deliver innovative web solutions for clients globally. Our team of tech experts excels in leveraging the power of technology for businesses across various industry verticals. We provide business-driven and growth-centric web development services with faster turnaround times and better ROI for businesses. Here’s why you should choose us:',
    },
    aboutUsPoints: [
...
export const webDevIndustry: SectionHeadingWithoutStylingProps = {
    title: "Industries We Serve",
    description: "As a top web development services provider, we deliver comprehensive web development solutions tailored to meet specific industry needs. Empower your business with our tech expertise and solutions to overcome industry challenges. We serve various industry verticals, including:"
}

export const imageWeb: ImageLayout = {
