...
export const CustomAppHeading: SectionHeadingWithoutStylingProps = {
    title: 'Custom Software Development Company',
    description: 'Upscale your business with our innovative and unique software solutions to gain the competitive advantage that enables new efficiencies and improves ROI.'
}
export const CustomAppServiceHeading: SectionHeadingWithoutStylingProps = {
    title: 'Custom Software Development Services',
    description:
        'Using our tech expertise and vast industry experience, we offer end-to-end custom software development services using various technologies to meet the unique business challenges of each of our clients. Here are some of our software development solutions:',

}
export const CustomAppServices: ServicesProps = {
    images: {
        image1: {
    ...
    sectionHeading: {
        ...
        description: 'Techares is a leading custom software development company backed by an industry-certified digital product team proficient in building reliable, scalable, and secure software products. With 250+ developers on board, we\'ve delivered 150+ next - generation websites and mobile applications for major brands and Fortune 500 companies around the world.From strategy and UI/ UX design to development, we take care of your complete product and build it for you as we always do.\nWhether you require a simple single-page application for your business or complex applications to manage your entire work process, our developers have worked on a large variety of domains and projects that specifically meet your needs. We are a one-stop team to bring your idea to the market.'
    ...
    cards: [
        {
            ...
            title: 'Custom Software Development',
            description:
                'From ideation to quality control to post-deployment, we help businesses create impactful, user-centric software applications that enhance productivity and bring tangible business outcomes. Leverage our custom software development services to speed up your time to market and outperform the competition.',
        },
        {
            icon: <Icon1 />,
            title: 'Web/Mobile App Development',
            description:
                'Build engaging web and mobile applications that maximize your online presence globally. Our next-gen development services have delivered websites and apps for startups and leading organizations across 15+ diverse industries, amplifying their online presence with client-centric solutions.',
        },
        {
            icon: <Icon1 />,
            title: 'Enterprise Software Development',
            description:
                'Empower your business with modern enterprise solutions that automate processes and elevate operational efficiency. With over 10 years of experience, we specialize in enterprise software development, API integration, and modernizing legacy systems across various business domains.',
        },
        {
            icon: <Icon1 />,
            title: 'Software Consulting',
            description:
                'Blending cutting-edge technology, processes, and industry expertise, we deliver comprehensive software consulting services. Whether starting from scratch or transforming your existing business strategy, we provide solutions that unlock results faster and help your business thrive in new ecosystems.',
        },
        {
            icon: <Icon1 />,
            title: 'QA & Testing',
            description:
                'Utilizing extensive experience in QA and testing, we implement top software testing methodologies, including functional, performance, and automated testing. Our approach ensures software applications are highly usable, of perfect quality, and free of bugs.',
        },
        {
            icon: <Icon1 />,
            title: 'Digital Transformation',
            description:
                'Using advanced technologies like AI, IoT, and Cloud Computing, we help businesses transform digitally with our digital transformation services. Our team develops digital solutions that enhance operational efficiency and modernize your business models.',
        },
    ],
}
...
export const customAppSolutions: SectionHeadingWithoutStylingProps = {

    title: 'Custom Software Development Solutions We Offer',
    description: 'We are experts in offering a wide array of software solutions that fit every unique business need. Whether developing custom applications from scratch or adding to the existing applications, our developers provide the full potential to drive your business forward. Take a look at our few mind-blowing solutions:'
        ...
        posts: [
            {
                ...
                heading: 'ERP',
                titleone:
                    'With vast experience in enterprise software development, we build scalable ERP software tailored to the specific needs of each business, from inventory and supply chain to distribution and sales. Our custom ERP solutions help businesses automate work processes and monitor key data across web and mobile platforms.',
        ...
        posts: [
            {
                ...
                heading: 'CRM',
                titleone:
                    'By leveraging our CRM software solutions, many organizations maintain greater customer and sales relationships. As the most trusted software development company, we deliver highly optimal and well-customized CRM development solutions that help businesses track, monitor, and analyze customer data and increase sales efforts.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                heading: 'HR Software',
                titleone:
                    'Manage your hiring, payroll, recruiting, onboarding, and learning processes in a smarter way with our Human Resource (HR) software solutions. Our HR software simplifies human resource operations, enhancing efficiency in the HR process. Automate your complete HR workflows by partnering with us.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                titleone:
                    'Our enterprise development services help large enterprises transform and automate their business processes. Whether developing an enterprise application from scratch or integrating it into existing business systems, our developers will modernize your enterprise to remain competitive in the digital era.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                titleone:
                    'Our developers are experienced in designing and implementing data analytics software that utilizes big data solutions to analyze vast amounts of data and derive insights. This aids businesses in making informed decisions, market forecasting, trend analysis, and increasing operational efficiency.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
        ...
        posts: [
            {
                ...
                titleone:
                    'We provide customized IT service management software solutions that help businesses automate and rapidly consolidate their IT service workflows. Our developers design ITSM software tailored to your requirements, helping you track and resolve issues while recording and maintaining all data on the cloud seamlessly.',
                imageUrl: 'assets/images/landing/software/1.png',
            },
        ] as StandardPost[],
    },
...
export const customAppTech: SectionHeadingWithoutStylingProps = {
    title: "Technology Stack Our Custom Software Developers Use",
    description: "Our custom software developers are skilled in providing software development services utilizing these tech stacks."
}
export const CustomAppServiceSectionData: ServiceSectionPropss = {
    services: [
        {
            icon: <Icon1 />,
            title: 'Banking & Fintech',
            description:
                'We build scalable banking and fintech apps, payment gateways, blockchain wallets, and more, providing result-oriented solutions to fintech businesses.',
        },
        {
            icon: <Icon1 />,
            title: 'Retail & E-Commerce',
            description:
                'We deliver next-generation and feature-rich eCommerce solutions that empower B2B & B2C businesses, helping them reach more customers and increase sales.',
        },
        {
            icon: <Icon1 />,
            title: 'Healthcare & Fitness',
            description:
                'Techares offers smart healthcare app development solutions to help you manage digital healthcare operations effectively and efficiently.',
        },
        {
            icon: <Icon1 />,
            title: 'Supply Chain & Logistics',
            description:
                'We provide comprehensive transport and logistics app solutions to digitize your entire supply chain, driving your business towards sustainable operations.',
        },
        {
            icon: <Icon1 />,
            title: 'Travel & Tourism',
            description:
                'We offer travel app solutions including trip planning, booking (hotel, flight, car, bus), and local guide apps, catering to all types of travel and tourism businesses.',
        },
        {
            icon: <Icon1 />,
            title: 'Sports & Games',
            description:
                'Develop specialized sports apps that create next-level virtual experiences for fans and generate significant revenue for your business.',
        },
        {
            icon: <Icon1 />,
            title: 'Media & Entertainment',
            description:
                'Using cutting-edge technologies, we help you launch OTT apps, digital SCM, media, and entertainment apps tailored to your business needs.',
        },
        {
            icon: <Icon1 />,
            title: 'Education & E-Learning',
            description:
                'Tap into the lucrative online learning app market by developing innovative education apps for teachers, professionals, and learners.',
        },
    ],
};

export const WhatMakesCustomApp: WhatMakesProps = {
    sectionHeading2: {
        title: 'What Makes Us Top Custom Software Development Company',
        description:
            'Being the top custom software development company in the industry for over 10+ years, Techares uses groundbreaking technologies to deliver innovative software solutions for clients across the globe. Our team of tech experts has great expertise in leveraging the power of technologies for businesses in various industry verticals. We provide business-driven and growth-centric software development services with faster turnaround time and better ROI for businesses. Here are the reasons why to join hands with us:',
    },
    aboutUsPoints: [
...
export const customAppIndustry: SectionHeadingWithoutStylingProps = {
    title: "Industries We Serve",
    description: "As a top custom software development services provider, we provide complete custom software development solutions catering to specific industry needs. Enrich your business capabilities with our tech experts and solutions to meet your industry challenges. We serve across various industry verticals such as:"
}

export const imageCustomApp: ImageLayout = {
